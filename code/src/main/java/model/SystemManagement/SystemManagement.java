...
public class SystemManagement {
    ...
    public SystemManagement(String idSystemManagement, String description, String certificate, ArrayList<Standard> standards, ArrayList<OtherRequirement> otherRequirements) {
