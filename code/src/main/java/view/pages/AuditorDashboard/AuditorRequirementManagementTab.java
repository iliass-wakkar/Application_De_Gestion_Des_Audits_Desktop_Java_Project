...
import controller.uiControllers.AuditorDashboard.tabs.AuditorRequirementManagementTabController;
...
public class AuditorRequirementManagementTab extends JPanel {
    ...
    private AuditorRequirementManagementTabController auditorRequirementManagementTabController;
    ...
    public AuditorRequirementManagementTab() {
        ...
        auditorRequirementManagementTabController = new AuditorRequirementManagementTabController(this);
        setUpUi();
    }
    ...
    private void setUpUi() {
        ...
        actionsColumn.setCellEditor(new ButtonEditor(new JCheckBox(), requirementTable, auditorRequirementManagementTabController.getIButtonEditorEventsHandler()));
    ...
    public static void main(String[] args) {
        ...
        AuditorRequirementManagementTab auditorRequirementManagementTab = new AuditorRequirementManagementTab();
        frame.add(auditorRequirementManagementTab);
