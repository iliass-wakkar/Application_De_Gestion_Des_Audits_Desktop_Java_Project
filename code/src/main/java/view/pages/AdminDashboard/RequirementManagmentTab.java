...
import controller.uiControllers.adminDashboard.Tabs.RequirementManagmentTabController;
...
public class RequirementManagmentTab extends JPanel {
    ...
    private RequirementManagmentTabController requirementManagmentTabController;
    private static String[] columnNamesCreateEdit = {
            "IdOrganization", "IdManagmentSystem", "Description", "Reference", "Name"
    };
    DefaultTableModel model;
    JTable requirementTable;

    public RequirementManagmentTab() {
        ...
        requirementManagmentTabController = new RequirementManagmentTabController(this);
        setUpUi();
    }
    ...
    private void setUpUi() {
        ...
        // Define column names
        String[] columnNames = {
                "IdOtherRequirement", "IdOrganization", "IdManagmentSystem", "Description", "Reference", "Name",  "Actions"
        };
        ...
        actionsColumn.setCellEditor(new ButtonEditor(new JCheckBox(), requirementTable, requirementManagmentTabController.getIButtonEditorEventsHandler()));
    ...
    public void refreshTable() {
        ...
        for (Requirement requirement : data) {
            Object[] rowData = {
                    ...
                    requirement.getIdManagmentSystem(),
    ...
    public static void main(String[] args) {
        ...
        RequirementManagmentTab requirementManagmentTab = new RequirementManagmentTab();
        frame.add(requirementManagmentTab);
